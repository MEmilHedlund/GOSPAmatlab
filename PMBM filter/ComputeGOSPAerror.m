...
function   [squared_gospa,gospa_loc,gospa_mis,gospa_fal]=ComputeGOSPAerror(X_estimate,postruths,X_truth,ntargets,c_gospa,k)
...
X_pos_truth_k=postruths{k};

X_estimate_pos=X_estimate(1:2:end);
%X_estimate_pos=X_estimate_pos(1:numel(postruths{k}));
